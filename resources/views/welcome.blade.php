    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                ...
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">There are plenty of slots in the system waiting for your hotel/resort to take place!</h3>
            </div>
        </div>
    </div>
    <div class="container">
            ...
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                    ...
                    <form class="mbr-form" action="" method="post" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="qSHaKs2qUWw4q50KfITYm8C+l4PBZhMmduyJGHT/TFlBfuLxzPnSdyLXBgNRQFRC3CznWWt5lw9HngVhRC3vMenGPNvMfIBE+GAymxxXg+uOyAKxZh3FLgEGvKM37GY7" data-form-field="Email">
                        ...
                        <div class="form-group" data-for="message">
                            ...
                            <textarea type="text" class="form-control" name="message" rows="7" data-form-field="Message" placeholder="Please fill your resort information ex. name, location" id="message-form1-p"></textarea>
                        </div>
            
                        <span class="input-group-btn"><button href="" type="submit" class="btn btn-primary btn-form display-4">SEND REQUEST</button></span>
                    </form>
            </div>
        </div>
    </div>
        ...
        <div class="media-container-row">
            ...
            <div class="card p-3 col-12 col-md-6 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper media-container-row">
                    <div class="card-box">
                        <h4 class="card-title pb-3 mbr-fonts-style display-7">CONTACT US</h4>
                        <p class="mbr-text mbr-fonts-style display-7">+66 91 723 8778 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<br>Address : Faculty of IT<br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;1 Chalong Krung road<br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Lad Krabang, Bangkok<br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;10520, Thailand<br></p>
                    </div>
                </div>
            </div>
